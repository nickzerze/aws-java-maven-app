            ...
            steps {
                script {
                    ...
                    sshagent(['ec2-instance-aws-java-maven-app']) {
                        ...
                        sh "scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null server-cmds.sh ec2-user@18.196.157.154:/home/ec2-user"

                        //Μετά κάνω copy το docker-compose.yaml στο EC2 instance
                        sh "scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null docker-compose.yaml ec2-user@18.196.157.154:/home/ec2-user"
                        ...
                        sh "ssh -o StrictHostKeyChecking=no ec2-user@18.196.157.154 ${shellCmd}"
                    }
                }
            }
        }        
